...
public class ArrayIndexedCollection implements List {
	...
	private static class ConcreteElementsGetter implements ElementsGetter {
		...
		private int lastDeliveredObjectIndex = -1;
		private long savedModificationCount;

		public ConcreteElementsGetter(ArrayIndexedCollection arrayIndexedCollection, long modificationCount) {
		...
		public Object getNextElement() {
			...
			return collection.get(++lastDeliveredObjectIndex);
		}
	...
	private void initializeSize(int initialCapacity, Collection collection) {
		...
		size = (initialCapacity<collection.size())? collection.size() : initialCapacity;
	}
